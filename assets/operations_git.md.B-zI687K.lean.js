import{_ as a,c as i,a4 as n,o as p}from"./chunks/framework.BDeXF6e8.js";const d=JSON.parse('{"title":"使用git上传文件到gitea","description":"","frontmatter":{},"headers":[],"relativePath":"operations/git.md","filePath":"operations/git.md","lastUpdated":1734425890000}'),t={name:"operations/git.md"};function e(l,s,h,o,r,k){return p(),i("div",null,s[0]||(s[0]=[n(`<h1 id="使用git上传文件到gitea" tabindex="-1">使用git上传文件到gitea <a class="header-anchor" href="#使用git上传文件到gitea" aria-label="Permalink to &quot;使用git上传文件到gitea&quot;">​</a></h1><p>1.创建账号自己账号</p><p>2.创建一个gitee仓库</p><p>3.新建一个文件夹，</p><p>4.在该文件下右键git bash here，输入命令“git init”进行初始化</p><p>5.关联本地仓库和远端仓库</p><pre><code>git remote add origin “你仓库地址，无引号”
